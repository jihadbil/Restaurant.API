...
namespace Restaurant.DataAccess.Migrations
{
    ...
    public partial class addMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CategoryPrintStations",
                columns: table => new
                {
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    PrintStationId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryPrintStations", x => new { x.CategoryId, x.PrintStationId });
                    table.ForeignKey(
                        name: "FK_CategoryPrintStations_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryPrintStations_PrintStations_PrintStationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Printers_PrintStations_PrintStationId",
                        column: x => x.PrintStationId,
                        principalTable: "PrintStations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitDiscount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Total = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryPrintStations_PrintStationId",
                table: "CategoryPrintStations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Printers_PrintStationId",
                table: "Printers",
                column: "PrintStationId");
